...
@Component({
  selector: 'app-add-marketing-campaigns',
  standalone: true,
        ...
        <div>
          ...
          <div class="mt-1 relative rounded-md shadow-sm">
            ...
            <input
              ...
              [class.border-red-500]="submitted && campaign.budget === 0"
            />
          </div>
          <p *ngIf="submitted && campaign.budget === 0" class="mt-1 text-sm text-red-600">
            Budget is required
          </p>
        </div>
...
export class AddMarketingCampaignsComponent {
  campaign = {
    campaign_name: '',
    target_audience: '',
    budget: 0,
  ...
  onSubmit() {
    ...
    this.marketingService.addCampaign(this.campaign).subscribe({
      next: () => {
        Swal.fire({
          title: 'Success!',
